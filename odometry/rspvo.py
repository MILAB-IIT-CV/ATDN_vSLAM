...
from layers.experimental import Spatial, ResidualSpatial



class ResidualSpatialVO(nn.Module):
    __doc__="""
    ...
    def __init__(
        ...
        self.encoder_CNN = nn.Sequential(
            ...
            ResidualSpatial(in_height=376, in_width=1232, hidden=512, channels=2, stride=2),
            ResidualSpatial(in_height=188, in_width=616, hidden=512, channels=2, stride=2),
            ResidualSpatial(in_height=94, in_width=308, hidden=256, channels=2, stride=2),
            ResidualSpatial(in_height=47, in_width=154, hidden=128, channels=2, stride=2),
            ResidualSpatial(in_height=24, in_width=77, hidden=64, channels=2, stride=2),
            nn.Flatten(),
